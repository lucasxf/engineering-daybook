    ...
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4" noValidate>
      ...
      >
        <textarea
          ...
          className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:focus:border-blue-400 dark:focus:ring-blue-400"
        />
      </FormField>
