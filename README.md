...
- [x] Discovery Feed — social feed aggregating own learnings and re-learnings from followed learners (GET /api/v1/feed); Discover page with learner search by handle/name (GET /api/v1/learners/search); mobile social feed via useFeedData hook; 17 E2E tests
