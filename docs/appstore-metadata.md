# App Store Connect — Metadados learnimo

> Bundle ID: `net.learnimo.app`
> Gerado em: 2026-04-16

---

## Texto Promocional
*(máx. 170 chars — pode atualizar sem novo review)*

```
Registre o que aprendeu hoje. Organize com tags. Encontre qualquer coisa com busca semântica — não só palavras exatas.
```
...
## Palavras-chave
*(máx. 100 chars — sem espaço após vírgula)*

```
aprendizado,diário,conhecimento,estudo,notas,learning,journal,tags,busca,memória,recall
```
...
- **Arquivo de cobertura de roteamento (.geojson):** Não se aplica — deixar em branco.
- **Idioma desta listagem:** Português (Brasil)
- Para adicionar localização em inglês, duplicar este arquivo como `appstore-metadata-en.md` e traduzir.
