...
web_excl = ['__tests__/', '.test.ts', '.test.tsx', '.spec.ts', '.spec.tsx']
web_prod = count_lines(['web/src/**/*.ts', 'web/src/**/*.tsx'], web_excl)
web_test = count_lines(['web/src/**/*.test.ts', 'web/src/**/*.test.tsx'])
e2e_test = count_lines(['web/e2e/**/*.ts'])
mob_prod = count_lines(['mobile/src/**/*.ts', 'mobile/src/**/*.tsx'], web_excl)
...
ratio = (test_total / prod_total * 100) if prod_total else 0.0
