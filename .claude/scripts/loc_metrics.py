...
def main():
    ...
    mob_e2e_test = count_lines(['mobile/e2e/**/*.yaml'])

    prod_total = be_prod + web_prod + mob_prod
    test_total = be_test + web_test + e2e_test + mob_test + mob_e2e_test
    ...
    print(f'Test LOC:       {test_total:,}  (backend={be_test:,}, web={web_test:,}, e2e={e2e_test:,}, mobile={mob_test:,}, mob_e2e={mob_e2e_test:,})')
