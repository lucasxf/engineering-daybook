 ...
 * withCorePin.js
 *
 * Expo SDK 53 targets compileSdk 35 with AGP 8.8.x. androidx.core:1.17.0+
 * requires compileSdk 36 + AGP 8.9.1 and will fail the build if resolved.
 *
 * This plugin forces androidx.core and core-ktx to 1.15.0 to prevent
...
// Force androidx.core to a version compatible with compileSdk 35 and AGP 8.8.x.
// androidx.core:1.17.0+ requires compileSdk 36 + AGP 8.9.1, which Expo SDK 53
...
const withCorePin = (config) => {
  return withAppBuildGradle(config, (cfg) => {
    ...
    if (!cfg.modResults.contents.includes('androidx.core:core:1.15.0')) {
      ...
      if (!cfg.modResults.contents.includes('androidx.core:core:1.15.0')) {
        throw new Error(
          '[withCorePin] Could not insert resolution strategy — ' +
