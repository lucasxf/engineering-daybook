...
*Last updated: 2026-03-26 (session: fix/tag-creation-flow — fix tag creation flow: i18n %{name} interpolation, error discrimination in handleCreateTag; add findAllByType array-node traversal pitfall)*
