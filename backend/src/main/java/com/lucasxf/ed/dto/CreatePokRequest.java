 ...
 * Visibility is optional; when null the learner's {@code defaultPokVisibility} preference is used.
 *
 ...
 * @param visibility optional explicit visibility (null → use user default)
